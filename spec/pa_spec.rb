RSpec.describe "Pa::Client" do
  describe "#authenticate" do
    it "returns true on success" do
      ...
      api_client = Pa::Client.new(host: "localhost", port: 9000, username: "admin", password: "secret", http_client: http)
    ...
    it "raises authentication error on failure" do
      ...
      api_client = Pa::Client.new(host: "localhost", port: 9000, username: "admin", password: "badsecret", http_client: http)
