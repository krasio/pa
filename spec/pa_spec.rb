RSpec.describe "Pa::Client" do
  describe "#authenticate" do
    ...
    it "raises authentication error on failure" do
      ...
      expect {api_client.authenticate}.to raise_error Pa::Client::Error, %(Authentication failed with: "Two-factor Authentication is needed".)
    end
    ...
    it "raises api error on request failure" do
      ...
      expect {api_client.authenticate}.to raise_error Pa::Client::Error, %(API request failed with: "418 I'm a teapot".)
    end
  end
